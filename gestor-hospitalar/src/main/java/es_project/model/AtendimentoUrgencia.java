...
public class AtendimentoUrgencia {
    ...
    public int getId_sala_urgencia() {
        return id_sala_urgencia;
    }

    public boolean isSala_urgencia_ocupada() {
        return sala_urgencia_ocupada;
    }

    /* SETTERS */

    public void setId_sala_urgencia(int id_sala_urgencia) {
        this.id_sala_urgencia = id_sala_urgencia;
    }
